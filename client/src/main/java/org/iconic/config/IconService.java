...
/**
 * <p>An icon service provides users with access to icons
 *
 * <p>Implementers of this interface can retrieve icons either locally or from a web-based resource,
 * as such it's important to ensure that any icon service used is instantiated as soon as possible.
 */
public interface IconService {
    /**
     * <p>Returns an icon based on the provided glyph identifier
     *
