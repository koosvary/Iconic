...
set CLASSPATH=%APP_HOME%\lib\gene-expression-core-0.0.5.jar;%APP_HOME%\lib\lombok-1.16.16.jar

@rem Execute api
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %API_OPTS%  -classpath "%CLASSPATH%" org.aiconic.Main %CMD_LINE_ARGS%
