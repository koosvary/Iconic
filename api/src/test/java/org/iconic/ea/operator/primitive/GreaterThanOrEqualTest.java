...
/**
 * Test class for {@link GreaterThanOrEqual}
 * @author Jack Newley
 */
...
public class GreaterThanOrEqualTest {
    ...
    @DisplayName("Test GreaterThanOrEqual using doubles")
    @MethodSource("doubleListProvider")
    @ParameterizedTest
    void addDoublesTest(final List<Double> args, final double expected) {
        final FunctionalPrimitive<Double, Double> greaterThanOrEqual = new GreaterThanOrEqual();
        final double delta = 0.001d;
        final double actual = greaterThanOrEqual.apply(args);
